...
def index():
    ...
    <p>“Never forget what you are, for surely the world will not. Make it your strength.<br>Then it can never be your weakness. Armour yourself in it, and it will never be used to hurt you.”</p>
    <footer class="blockquote-footer">George R.R. Martin, A Game of Thrones </footer>
  </blockquote>""")
    session["books"]=[]   
...
def bookpage(isbn):
    ...
    res = requests.get("https://www.goodreads.com/book/review_counts.json", params={"key": "aAPcpaNPzN7IZQgDJc9OQ", "isbns": isbn})
